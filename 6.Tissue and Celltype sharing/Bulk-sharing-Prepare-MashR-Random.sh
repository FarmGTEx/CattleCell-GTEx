...
dir_output="/faststorage/project/cattle_gtexs/CattleGTEx/OmiGA/MASHR_Celltype/Tissue_sharing/Bulk/Random_output"
...
/faststorage/project/cattle_gtexs/CattleGTEx/OmiGA/MASHR_Celltype/combine_signif_pairs_tjy.py ${dir_output}/nominal_combined_files.txt nominal_pairs -o ${dir_output}
...
do
{
    ...
    # extract_pairs
    python3 /faststorage/project/cattle_gtexs/CattleGTEx/OmiGA/MASHR_Celltype/extract_pairs_tjy.py ${dir_output}/${tissue}.nominal_files2.txt ${dir_output}/nominal_pairs.combined_signifpairs.txt.gz ${tissue}_nominal_pairs -o ${dir_output}
...
python3 /faststorage/project/cattle_gtexs/CattleGTEx/OmiGA/MASHR_Celltype/mashr_prepare_input.py ${dir_output}/nominal_pairs_files.txt nominal_pairs.${subset_size}_subset -o ${dir_output} --only_zscore --dropna --subset $subset_size --seed 9823
